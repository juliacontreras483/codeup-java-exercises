...
//    Create a inheritanceLecture.Vehicle class:
//        - add the following private properties:
//        1. boolean isOperable (intended to describe if the vehicle is functional or brokengit )
...
//        Create a inheritanceLecture.Car class that extends inheritanceLecture.Vehicle (no need to add anything to it yet)
//        Create a inheritanceLecture.Jet class that extends inheritanceLecture.Vehicle (no need to add anything to it yet)
//        Create a inheritanceLecture.VehicleTest class
//  - add a main method and create a inheritanceLecture.Vehicle, inheritanceLecture.Jet, and inheritanceLecture.Car object, setting values for each and testing out the output of .toString() method for each
